...
import { Mint as MintEvent } from "../generated/MKRToken/MKRToken"
import { handleMint } from "../src/mkr-token"
import { createMintEvent } from "./mkr-token-utils"
...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    ...
    let newMintEvent = createMintEvent(guy, wad)
